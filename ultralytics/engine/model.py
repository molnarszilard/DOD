...
class Model(nn.Module):
    ...
    def _smart_load(self, key: str):
        ...
        try:
            # task: classify, detect, segment, pose, obb, dod
            # key: model(e.g. 'ultralytics.nn.tasks.OBBModel'), trainer ('ultralytics.models.yolo.obb.train.OBBTrainer'), validator ('ultralytics.models.yolo.obb.train.OBBValidator'), predictor ('ultralytics.models.yolo.obb.train.OBBPredictor')
